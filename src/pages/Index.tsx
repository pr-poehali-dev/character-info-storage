...
const Index = () => {
  ...
  const handleAddCharacter = () => {
    toast({
      ...
      description:
        "Создание новых персонажей будет доступно в следующем обновлении",
    });
  };
  ...
  const handleEditCharacter = (id: string) => {
    toast({
      title: "Функция в разработке",
      description:
        "Редактирование персонажей будет доступно в следующем обновлении",
    });
  };
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <header className="mb-8">
          <h2 className="text-3xl font-playfair font-bold text-secondary">
            Ваша коллекция персонажей
          </h2>
          <p className="text-muted-foreground">
            Ваши истории и герои в одном месте
          </p>
        </header>
                ...
                <div className="rounded-lg overflow-hidden border border-border/40">
                  <img
                    src={
                      ...
                      `https://source.unsplash.com/random/300x300/?portrait,fantasy&sig=${selectedCharacter.id}`
                    }
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Это действие нельзя отменить. Персонаж будет удален из вашей
              коллекции навсегда.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
